...
class Data_HG19MetadataRangesItem(messages.Message):
    ...
    aliquot_gdc_id                                                    = messages.StringField(3, repeated=True)
    analysis_workflow_type                                            = messages.StringField(4, repeated=True)
    ...
    species                                                           = messages.StringField(22, repeated=True)
    
class Data_HG19MetadataItem(messages.Message):
    access                                                            = messages.StringField(1)
    aliquot_barcode                                                   = messages.StringField(2)
    aliquot_gdc_id                                                    = messages.StringField(3)
    analysis_workflow_type                                            = messages.StringField(4)
    ...
    species                                                           = messages.StringField(22)
