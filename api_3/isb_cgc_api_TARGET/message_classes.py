...
class MetadataRangesItem(messages.Message):
    ...
    case_barcode                                                      = messages.StringField(40, repeated=True)
    endpoint_type                                                     = messages.StringField(41, repeated=True)
    program_name                                                      = messages.StringField(42, repeated=True)
    project_disease_type                                              = messages.StringField(43, repeated=True)
    project_short_name                                                = messages.StringField(44, repeated=True)
    sample_barcode                                                    = messages.StringField(45, repeated=True)
    sample_gdc_id                                                     = messages.StringField(46, repeated=True)
    sample_type                                                       = messages.StringField(47, repeated=True)
    tumor_code                                                        = messages.StringField(48, repeated=True)
...
class MetadataItem(messages.Message):
    ...
    case_barcode                                                      = messages.StringField(22)
    endpoint_type                                                     = messages.StringField(23)
    program_name                                                      = messages.StringField(24)
    project_disease_type                                              = messages.StringField(25)
    project_short_name                                                = messages.StringField(26)
    sample_barcode                                                    = messages.StringField(27)
    sample_gdc_id                                                     = messages.StringField(28)
    sample_type                                                       = messages.StringField(29)
    tumor_code                                                        = messages.StringField(30)
