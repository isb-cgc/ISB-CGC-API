...
class MetadataRangesItem(messages.Message):
    ...
    disease_code                                                      = messages.StringField(12, repeated=True)
    endpoint_type                                                     = messages.StringField(13, repeated=True)
    ethnicity                                                         = messages.StringField(14, repeated=True)
    event_free_survival                                               = messages.IntegerField(15, repeated=True, variant=messages.Variant.INT32)
    event_free_survival_lte                                           = messages.IntegerField(16, variant=messages.Variant.INT32)
    event_free_survival_gte                                           = messages.IntegerField(17, variant=messages.Variant.INT32)
    
    first_event                                                       = messages.StringField(18, repeated=True)
    gender                                                            = messages.StringField(19, repeated=True)
    overall_survival                                                  = messages.IntegerField(20, repeated=True, variant=messages.Variant.INT32)
    overall_survival_lte                                              = messages.IntegerField(21, variant=messages.Variant.INT32)
    overall_survival_gte                                              = messages.IntegerField(22, variant=messages.Variant.INT32)
    
    program_name                                                      = messages.StringField(23, repeated=True)
...
class MetadataItem(messages.Message):
    ...
    disease_code                                                      = messages.StringField(6)
    ...
    overall_survival                                                  = messages.IntegerField(12, variant=messages.Variant.INT32)
