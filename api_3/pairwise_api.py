...
from api_3.api_helpers import authorize_credentials_with_Google
from api_3.pairwise import Pairwise
...
Pairwise_Endpoints = endpoints.api(name='pairwise', version='v3')
