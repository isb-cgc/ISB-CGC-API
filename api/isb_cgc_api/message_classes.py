...
class MetadataAnnotationItem(messages.Message):
    ...
    dateAdded                      = messages.None(8)
    dateCreated                    = messages.None(9)
    dateEdited                     = messages.None(10)
    itemBarcode                    = messages.StringField(11)
    itemTypeId                     = messages.IntegerField(12, variant=messages.Variant.INT32)
    itemTypeName                   = messages.StringField(13)
    ParticipantBarcode             = messages.StringField(14)
    SampleBarcode                  = messages.StringField(15)
    Study                          = messages.StringField(16)