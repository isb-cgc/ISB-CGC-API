...
# @collections_bp.route('/collections/', methods=['GET'], strict_slashes=False)
# def collections():
#     """Retrieve the list of collections and versions currently available for cohort creation."""
#     response = None
#
#     try:
#
#         collection_info = get_collections()
#
#         if collection_info:
#             response = jsonify({
#                 'code': 200,
