...
class IncomingRangesMetadataItem(messages.Message):
    ...
    height                                                          = messages.IntegerField(58, repeated=True)
    height_lte                                                      = messages.IntegerField(59)
    height_gte                                                      = messages.IntegerField(60)

    histological_type                                               = messages.StringField(61, repeated=True)
    history_of_colon_polyps                                         = messages.StringField(62, repeated=True)
    history_of_neoadjuvant_treatment                                = messages.StringField(63, repeated=True)
    history_of_prior_malignancy                                     = messages.StringField(64, repeated=True)
    hpv_calls                                                       = messages.StringField(65, repeated=True)
    hpv_status                                                      = messages.StringField(66, repeated=True)
    icd_10                                                          = messages.StringField(67, repeated=True)
    icd_o_3_histology                                               = messages.StringField(68, repeated=True)
    icd_o_3_site                                                    = messages.StringField(69, repeated=True)
    lymphatic_invasion                                              = messages.StringField(70, repeated=True)
    lymphnodes_examined                                             = messages.StringField(71, repeated=True)
    lymphovascular_invasion_present                                 = messages.StringField(72, repeated=True)

    max_percent_lymphocyte_infiltration                             = messages.IntegerField(73, repeated=True)
    max_percent_lymphocyte_infiltration_lte                         = messages.IntegerField(74)
    max_percent_lymphocyte_infiltration_gte                         = messages.IntegerField(75)

    max_percent_monocyte_infiltration                               = messages.IntegerField(76, repeated=True)
    max_percent_monocyte_infiltration_lte                           = messages.IntegerField(77)
    max_percent_monocyte_infiltration_gte                           = messages.IntegerField(78)

    max_percent_necrosis                                            = messages.IntegerField(79, repeated=True)
    max_percent_necrosis_lte                                        = messages.IntegerField(80)
    max_percent_necrosis_gte                                        = messages.IntegerField(81)

    max_percent_neutrophil_infiltration                             = messages.IntegerField(82, repeated=True)
    max_percent_neutrophil_infiltration_lte                         = messages.IntegerField(83)
    max_percent_neutrophil_infiltration_gte                         = messages.IntegerField(84)

    max_percent_normal_cells                                        = messages.IntegerField(85, repeated=True)
    max_percent_normal_cells_lte                                    = messages.IntegerField(86)
    max_percent_normal_cells_gte                                    = messages.IntegerField(87)

    max_percent_stromal_cells                                       = messages.IntegerField(88, repeated=True)
    max_percent_stromal_cells_lte                                   = messages.IntegerField(89)
    max_percent_stromal_cells_gte                                   = messages.IntegerField(90)

    max_percent_tumor_cells                                         = messages.IntegerField(91, repeated=True)
    max_percent_tumor_cells_lte                                     = messages.IntegerField(92)
    max_percent_tumor_cells_gte                                     = messages.IntegerField(93)

    max_percent_tumor_nuclei                                        = messages.IntegerField(94, repeated=True)
    max_percent_tumor_nuclei_lte                                    = messages.IntegerField(95)
    max_percent_tumor_nuclei_gte                                    = messages.IntegerField(96)

    menopause_status                                                = messages.StringField(97, repeated=True)

    min_percent_lymphocyte_infiltration                             = messages.IntegerField(98, repeated=True)
    min_percent_lymphocyte_infiltration_lte                         = messages.IntegerField(99)
    min_percent_lymphocyte_infiltration_gte                         = messages.IntegerField(100)

    min_percent_monocyte_infiltration                               = messages.IntegerField(101, repeated=True)
    min_percent_monocyte_infiltration_lte                           = messages.IntegerField(102)
    min_percent_monocyte_infiltration_gte                           = messages.IntegerField(103)

    min_percent_necrosis                                            = messages.IntegerField(104, repeated=True)
    min_percent_necrosis_lte                                        = messages.IntegerField(105)
    min_percent_necrosis_gte                                        = messages.IntegerField(106)

    min_percent_neutrophil_infiltration                             = messages.IntegerField(107, repeated=True)
    min_percent_neutrophil_infiltration_lte                         = messages.IntegerField(108)
    min_percent_neutrophil_infiltration_gte                         = messages.IntegerField(109)

    min_percent_normal_cells                                        = messages.IntegerField(110, repeated=True)
    min_percent_normal_cells_lte                                    = messages.IntegerField(111)
    min_percent_normal_cells_gte                                    = messages.IntegerField(112)

    min_percent_stromal_cells                                       = messages.IntegerField(113, repeated=True)
    min_percent_stromal_cells_lte                                   = messages.IntegerField(114)
    min_percent_stromal_cells_gte                                   = messages.IntegerField(115)

    min_percent_tumor_cells                                         = messages.IntegerField(116, repeated=True)
    min_percent_tumor_cells_lte                                     = messages.IntegerField(117)
    min_percent_tumor_cells_gte                                     = messages.IntegerField(118)

    min_percent_tumor_nuclei                                        = messages.IntegerField(119, repeated=True)
    min_percent_tumor_nuclei_lte                                    = messages.IntegerField(120)
    min_percent_tumor_nuclei_gte                                    = messages.IntegerField(121)

    mononucleotide_and_dinucleotide_marker_panel_analysis_status    = messages.StringField(122, repeated=True)
    mononucleotide_marker_panel_analysis_status                     = messages.StringField(123, repeated=True)
    neoplasm_histologic_grade                                       = messages.StringField(124, repeated=True)
    new_tumor_event_after_initial_treatment                         = messages.StringField(125, repeated=True)

    number_of_lymphnodes_examined                                   = messages.IntegerField(126, repeated=True)
    number_of_lymphnodes_examined_lte                               = messages.IntegerField(127)
    number_of_lymphnodes_examined_gte                               = messages.IntegerField(128)

    number_of_lymphnodes_positive_by_he                             = messages.IntegerField(101, repeated=True)
    ...
    psa_value                                                       = messages.FloatField(104, repeated=True)
    ...
    weight                                                          = messages.IntegerField(107, repeated=True)
    weight_lte                                                      = messages.IntegerField(108)
    weight_gte                                                      = messages.IntegerField(109)

    year_of_initial_pathologic_diagnosis                            = messages.IntegerField(110, repeated=True)
